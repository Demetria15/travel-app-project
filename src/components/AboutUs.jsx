...
function AboutUs() {
  return (
    <div className="about-container">
      <h1>Our History</h1>
      <p>
        GreenBuddyTrips is owned and managed by GreenBuddyTrips .In Pvt. Ltd., a leading brand in
        web designing services and e-commerce solutions. GreenBuddyTrips .In Pvt. Ltd. is
        ...
        rate of other portals managed by GreenBuddyTrips is a live paradigm of our work
        excellence.
      </p>
